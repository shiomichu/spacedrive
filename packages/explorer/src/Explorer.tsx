 ...
 */
export function Explorer(props: PropsWithChildren<Props>) {
		...
		<>
			<ExplorerContextMenu>
				<div
					...
					style={
						{
							'--scrollbar-margin-top': `${explorer.topPadding ?? 0}px`,
							'--scrollbar-margin-bottom': `${showPathBar ? PATH_BAR_HEIGHT : 0}px`,
							'paddingTop': explorer.topPadding ?? 0,
			...
			{showInspector && (
				<Inspector
					...
					style={{
						paddingTop: (explorer.topPadding ?? 0) + 12,
